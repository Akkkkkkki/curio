...
export const TEMPLATES: CollectionTemplate[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'type', label: 'Type', type: 'select', options: ['Dark', 'Milk', 'White', 'Inclusion', 'Ruby', 'Raw'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'speed', label: 'Speed', type: 'select', options: ['33 1/3 RPM', '45 RPM', '78 RPM'] },
      { id: 'condition', label: 'Condition', type: 'select', options: ['Mint (M)', 'Near Mint (NM)', 'Very Good Plus (VG+)', 'Very Good (VG)', 'Good (G)', 'Fair (F)'] },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { id: 'concentration', label: 'Concentration', type: 'select', options: ['Extrait de Parfum', 'Parfum', 'Eau de Parfum', 'Eau de Toilette', 'Eau de Cologne', 'Body Mist'] },
      { id: 'notes_top', label: 'Top Notes', type: 'text' },
      { id: 'notes_heart', label: 'Heart Notes', type: 'text' },
      { id: 'notes_base', label: 'Base Notes', type: 'text' },
      { id: 'season', label: 'Best Season', type: 'select', options: ['Spring', 'Summer', 'Autumn', 'Winter', 'All Year'] },
    ],
  ...
  },
  {
      ...
      fields: [
        ...
        { id: 'type', label: 'Spirit Type', type: 'select', options: ['Whisky', 'Gin', 'Rum', 'Tequila', 'Mezcal', 'Cognac', 'Vodka'] },
