...
export const translations = {
  en: {
    ...
    suggestTagsHint: 'Fast start, no setup',
    presetSeparator: '— or choose a preset —',
    ...
    pickTagsTitle: 'Pick tags for your collection',
    pickTagsDesc: 'Select suggestions or add your own.',
    suggestedTagsTitle: 'Suggested tags',
    suggestionsEmpty: 'No suggestions yet. Add your own tags to continue.',
    suggestionsUnavailable: 'Suggestions are unavailable. Add tags manually.',
    addYourOwn: 'Add your own',
    addTag: 'Add tag',
    addTagPlaceholder: 'Add a tag',
    tagLimitHelp: 'Tag limits: 3–6 recommended.',
    tagLimitReached: 'You can only add up to 6 tags.',
    tagTooLong: 'Tags should be {max} characters or fewer.',
  ...
  zh: {
    ...
    suggestTags: '建议标签',
    suggestTagsHint: '快速开始，无需设置',
    presetSeparator: '— 或选择预设 —',
    choosePreset: '选择预设模板',
    creatingSuggestions: '正在生成建议…',
    creatingSuggestionsFor: '正在获取：{item} 的灵感',
    pickTagsTitle: '选择收藏标签',
    pickTagsDesc: '从建议中挑选或添加自定义标签。',
    suggestedTagsTitle: '建议标签',
    suggestionsEmpty: '暂无建议标签，请添加自定义标签继续。',
    suggestionsUnavailable: '建议暂不可用，请手动添加标签。',
    addYourOwn: '自定义标签',
    addTag: '添加标签',
    addTagPlaceholder: '添加标签',
    tagLimitHelp: '标签建议 3–6 个。',
    tagLimitReached: '最多只能添加 6 个标签。',
    tagTooLong: '标签长度需不超过 {max} 个字符。',
    previewTitle: '预览',
