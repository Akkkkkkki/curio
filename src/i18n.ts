...
export const translations = {
  en: {
    ...
    heroSubtitle: 'A quiet home for the things you love.',
    featuredArtifact: 'In the spotlight',
    artifacts: 'Pieces',
    ...
    searchNoResultsBody: 'Nothing matches “{query}”. Try a different search.',
    ...
    firstRunEyebrow: 'Your museum begins here',
    firstRunTitle: 'Start your museum with one thing you love.',
    firstRunSubtitle: "A ticket stub, a tea tin, a record. We'll handle the rest.",
    firstRunPrimary: 'Add your first piece',
    firstRunSecondary: 'Wander a sample museum',
    firstRunFooter: 'No account needed to look around',
    ...
    museumDefinition: 'A museum is defined by what it protects. Start your collection today.',
    restoringArchives: 'Opening your museum...',
    addItem: 'Add Item',
    profile: 'Profile',
    add: 'Add',
    ...
    photoFirstHint: 'Start with the photo. Details can stay tucked away until you need them.',
    suggestedDetails: 'Suggested details',
    acceptSuggestion: 'Accept {field}: {value}',
    moreDetails: 'More details',
    collapseDetails: 'Hide details',
    saveToMuseum: 'Save to your museum',
    ...
    aiWillExtract: 'Add a photo and AI will suggest the details.',
    aiExtracting: 'AI is extracting details for your collection.',
    analysisTakingLong:
    ...
    analysisBusyTitle: 'AI is busy right now',
    analysisBusyDesc:
      'The analysis timed out or the service is overloaded. Retry, or add the details yourself.',
    analysisFailedTitle: "Couldn't analyze this photo",
    ...
    createAndAddFirst: 'Create & add first piece',
    continue: 'Continue',
    back: 'Back',
    next: 'Next',
    previous: 'Previous',
    ...
    fieldLimitHelp: 'Start with 1-2 pinned fields, then keep 3-6 fields total.',
    ...
    readOnlyItemDesc: 'Sign in as an admin or owner to edit this piece.',
    ...
    share: 'Share',
    sharing: 'Sharing…',
    shareUnavailableSavedInstead: "Sharing isn't available on this device — image saved instead.",
    ...
    fullTag: 'Immersive',
    retroTag: 'Vintage',
    archivalRecord: 'From my museum',
    ratedOutOfFive: 'Rated {rating} out of 5',
    addedOn: 'Added on {date}',
    artifactCataloged: '{n} piece',
    artifactsCataloged: '{n} pieces',
    itemCount: '{n} item',
    itemsCount: '{n} items',
    yes: 'Yes',
    no: 'No',
    ...
    onThisDayLastMonth: 'One Month Ago',
    onThisDayLastWeek: 'One Week Ago',
    historyTitle: 'From your museum',
    onThisDayMore: 'And {count} more',
    onThisDaySeeAll: 'See all {count} memories',
    themeSelection: 'App Aesthetic',
    changeTheme: 'Change theme',
    changeThemeCurrent: 'Change theme (current: {theme})',
    ...
    itemSaveStatusError: 'Save failed',
    ...
    sampleModeDesc:
      'You are browsing Curio in read-only sample mode. Configure Supabase when you are ready to save your own collection.',
    ...
    resendingResetLink: 'Resending…',
    resendResetLinkWait: 'Resend in {seconds}s',
    resendResetLinkSuccess: 'Sent again — check your inbox.',
    resendResetLinkError: "Couldn't resend. Try again in a moment.",
    useDifferentEmail: 'Use a different email',
    backToSignIn: 'Back to sign in',
    confirmEmailTitle: 'Almost there',
    confirmEmailSentTitle: 'Check your email',
    confirmEmailSentDesc:
      'We sent a confirmation link to {email}. Open it to finish creating your museum, then come back and sign in.',
  ...
  zh: {
    ...
    appSubtitle: '博物馆',
    heroTitle: '珍藏博物馆',
    heroSubtitle: '为你珍视之物，留一处安静的家。',
    featuredArtifact: '聚光灯下',
    artifacts: '藏品',
    archives: '收藏集',
    avgQuality: '平均品质',
    searchPlaceholder: '搜索你的收藏...',
    collectionSearchPlaceholder: '搜索此收藏...',
    itemTitlePlaceholder: '为此藏品命名',
    searchNoResultsTitle: '未找到匹配项',
    searchNoResultsBody: '没有结果匹配“{query}”。请尝试其他搜索词。',
    ...
    firstRunEyebrow: '你的博物馆从这里开始',
    firstRunTitle: '用一件你喜爱的物品，开启你的博物馆。',
    firstRunSubtitle: '一张票根、一只茶罐、一张唱片。其余的交给我们。',
    firstRunPrimary: '添加第一件藏品',
    firstRunSecondary: '逛逛示例博物馆',
    firstRunFooter: '只是看看，无需账号',
    homeWelcome: '欢迎回来',
    ...
    museumDefinition: '博物馆的价值，在于它所守护的一切。今天就开始你的收藏。',
    restoringArchives: '正在打开你的博物馆...',
    addItem: '添加藏品',
    profile: '个人中心',
    add: '添加',
    ...
    photoFirstHint: '先从照片开始。需要时再展开更多细节。',
    suggestedDetails: '建议细节',
    acceptSuggestion: '接受{field}：{value}',
    moreDetails: '更多细节',
    collapseDetails: '收起细节',
    saveToMuseum: '保存到你的博物馆',
    ...
    aiWillExtract: '添加照片，AI 会为您推荐馆藏细节。',
    aiExtracting: 'AI 正在为您提取馆藏细节。',
    ...
    analysisBusyTitle: 'AI 暂时繁忙',
    analysisBusyDesc: '分析超时或服务繁忙。可重试，或自行填写详细信息。',
    analysisFailedTitle: '无法分析这张照片',
    ...
    pinToCard: '固定到卡片',
    pinnedToCard: '已固定',
    fieldLimitHelp: '先固定 1-2 个字段，再保留 3-6 个字段。',
    ...
    readOnlyItemDesc: '以管理员或拥有者身份登录后可编辑此藏品。',
    cardStyle: '卡片风格',
    aspectRatio: '纵横比',
    imageFit: '图片填充',
    saveImage: '保存图片',
    ...
    share: '分享',
    sharing: '分享中…',
    shareUnavailableSavedInstead: '当前设备不支持分享，已为你保存图片。',
    ...
    fullTag: '身临其境',
    retroTag: '怀旧经典',
    archivalRecord: '来自我的博物馆',
    ratedOutOfFive: '评分 {rating} / 5',
    addedOn: '添加于 {date}',
    artifactCataloged: '{n} 件藏品',
    artifactsCataloged: '{n} 件藏品',
    itemCount: '{n} 件藏品',
    itemsCount: '{n} 件藏品',
    yes: '是',
    no: '否',
    ...
    onThisDay: '历史上的今天',
    onThisDayLastMonth: '一个月前',
    onThisDayLastWeek: '一周前',
    historyTitle: '来自你的博物馆',
    onThisDayMore: '还有 {count} 项',
    onThisDaySeeAll: '查看全部 {count} 条记忆',
    themeSelection: '应用美学主题',
    changeTheme: '切换主题',
    changeThemeCurrent: '切换主题（当前：{theme}）',
    themeGallery: '画廊（通透白）',
    themeVault: '保险库（深邃黑）',
    ...
    sampleModeDesc: '当前为只读示例模式。准备好保存自己的收藏时，再配置 Supabase 即可。',
    cloudSyncActive: '云同步',
    cloudSyncTitle: '云端账号',
    ...
    resendingResetLink: '正在重新发送…',
    resendResetLinkWait: '{seconds} 秒后可重发',
    resendResetLinkSuccess: '已重新发送——请查收邮箱。',
    resendResetLinkError: '重新发送失败，请稍后再试。',
    useDifferentEmail: '改用其他邮箱',
    backToSignIn: '返回登录',
    confirmEmailTitle: '就差一步',
    confirmEmailSentTitle: '请查收邮件',
    confirmEmailSentDesc: '确认链接已发送至 {email}。点击链接完成注册，然后回来登录。',
