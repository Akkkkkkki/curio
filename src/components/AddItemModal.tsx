...
export const AddItemModal: React.FC<AddItemModalProps> = ({
  ...
  // Once a photo or batch is being analyzed, closing can discard work the
  // user already selected. Keep the same lightweight close path for an empty
  // manual form, but confirm before dropping uploads, metadata, or batch rows.
  ...
  const hasAnalyzingWork =
    step === 'analyzing' && (!!imagePreview || !!batchProgress || batchItems.length > 0);
